...
Original columns: Date, Ticker, Open, High, Low, Close, Volume, Notes.
...
Dropped the notes column because it was mostly empty and not useful for analysis.
...
running_max and drawdown for peak-to-trough decline analysis.
...
Boxplots, histograms, line plots, and other comparative visualizations.
